...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/devapp/dev_applist.html">
			    ...
			    <ul>
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="queryCategoryLevel1" name="queryCategoryLevel1" id="queryCategoryLevel1" class="form-control">
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/devapp/appinfoadd.html" class="btn btn-success btn-sm">新增APP基础信息</a>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li>
                        	<c:choose>
											...
											<c:when test="${appInfo.status == 4}">
												<a class="saleSwichClose" status=${appInfo.status} saleSwitch="close" appinfoid=${appInfo.id }  appsoftwarename=${appInfo.softwareName } data-toggle="tooltip" data-placement="top" title="" data-original-title="您可以点击下架来停止发布您的APP，市场将不提供APP的下载">下架</a>
                        ...
                        <li><a href="${pageContext.request.contextPath }/devapp/look?appid=${appInfo.id }" class="viewApp" appinfoid=${appInfo.id }  data-toggle="tooltip" data-placement="top" title="" data-original-title="查看APP基础信息以及全部版本信息">查看</a></li>
  ...
  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width:${appInfo.zongxiazai}%">   
  </div>
<span style="margin-left:30px">${appInfo.zongxiazai}%</span>
</div>
</div></td>
									</tr>
								</c:forEach>
				...
				<pg:pager url="${pageContext.request.contextPath }/devapp/dev_applist.html" items="${totalCount }"
				export="currentPageNumber=pageNumber" maxPageItems="5" >
				
				<c:if test="${not empty querySoftwareName }">
   				<pg:param name="querySoftwareName" value="${querySoftwareName}"></pg:param>
   				</c:if>
   				
   				<c:if test="${not empty queryStatus }">
   				<pg:param name="queryStatus" value="${queryStatus}"></pg:param>
   				</c:if>
   				
   				<c:if test="${not empty queryFlatformId }">
   				<pg:param name="queryFlatformId" value="${queryFlatformId}"></pg:param>
   				</c:if>
   				
   				<c:if test="${not empty queryCategoryLevel1 }">
   				<pg:param name="queryCategoryLevel1" value="${queryCategoryLevel1}"></pg:param>
   				</c:if>
   				
   				<c:if test="${not empty queryCategoryLevel2 }">
   				<pg:param name="queryCategoryLevel2" value="${queryCategoryLevel2}"></pg:param>
   				</c:if>
   				
   				<c:if test="${not empty queryCategoryLevel3 }">
   				<pg:param name="queryCategoryLevel3" value="${queryCategoryLevel3}"></pg:param>
   				</c:if>
