    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/devapp/addversion.html" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
              ...
              <a href="${pageContext.request.contextPath}/devapp/dev_applist.html"><button type="button" class="btn btn-primary" id="back">返回</button></a>
            </div>
          </div>
        </form>
        </div>
