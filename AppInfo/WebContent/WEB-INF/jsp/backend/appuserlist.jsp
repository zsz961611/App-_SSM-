...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					APP 开发者用户管理 <i class="fa fa-user"></i><small>${devUserSession.devName}
			    ...
			    <ul>
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">登录用户名</label>
				...
				<div class="row">
					<div class="col-sm-12">
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<thead>
								<tr role="row">
									<th class="sorting_asc" tabindex="0"
										...
										aria-sort="ascending">开发者帐号(系统登录账号)</th>
							...
							<tbody>
								<c:forEach var="devUser" items="${devUser }" varStatus="status">
