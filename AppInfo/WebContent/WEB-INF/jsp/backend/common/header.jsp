        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> 用户管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/backend/findAlldevUser.html">后台用户管理</a></li>
                  ...
                  <li><a><i class="fa fa-bug"></i> 基础数据维护 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="${pageContext.request.contextPath }/manager/backend/category/list.html">APP分类管理</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="${pageContext.request.contextPath }/backendLogin/logout.html">
